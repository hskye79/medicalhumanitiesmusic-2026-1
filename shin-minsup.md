...
론 하워드(Ron Howard)가 감독한 영화 ‘뷰티풀 마인드(2002)’에는 조현병을 겪고있는 수학자의 삶이 담겨있다. 이 영화에서 사용되는 음악 ‘A Kaleidoscope of Mathematics‘는 작곡가 제임스 호너(James Horner)에 의해 작곡되었다. 이 영화의 음악은 단순한 배경이 아니라 주인공의 정신 상태를 직접적으로 드러내는 장치처럼 작용한다. 특히 반복되고 점층적으로 쌓이는 선율 구조는 수학적 사고의 질서와 동시에 점점 통제 불가능해지는 정신의 혼란을 함께 표현하며, 관객이 존 내시의 내면—즉 현실과 환상이 뒤섞인 세계—을 감각적으로 체험하게 만든다.
